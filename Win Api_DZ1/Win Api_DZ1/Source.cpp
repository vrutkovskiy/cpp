...
LPCTSTR lpszMenuName; //указатель на символьную строку (заканчивающуюся '/0') указывающий на \
имя ресурса класса меню (NULL - отсутствие меню)\n\n\
LPCTSTR lpszClassName; //имя класса может быть (из зарегистрированных???) символьной \
строкой не более 256!!! символов или АТОМ (системная таблица строчных и соответствующих \
идентификаторов (приложение записывает строку в таблицу АТОМов и получает соответствующее \
16-битное целое число, по которому можно получить доступ к строке)\n\n\
